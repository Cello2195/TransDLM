...
def main_worker(rank,world_size):
    ...
    if args.resume:
        print(f"Resume: {args.model_path}")
...
def create_argparser():
    ...
    text_defaults = dict(
        ...
        batch_size=64, 
        cache_mode='no', 
        checkpoint_path='../../checkpoints_smiles', 
        class_cond=False, 
        ...
        model_path='../../checkpoints/PLAIN_ema_0.9999_180000.pt',
        resume=False
    )
